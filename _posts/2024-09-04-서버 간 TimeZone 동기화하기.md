...
<figure>
    ...
    <figcaption>TimeZone: Asia/Seoul로 DB연결</figcaption>
</figure>

JDBC 연결 URL에 TimeZone정보를 Asia/Seoul로 해놓아 매 연결의 TimeZone이 Asia/Seoul로 고정시켜놨었습니다.

<figure>
    <img src="/assets/img/2024-09-04/img6.png" width="50%" alt="문제상황2">
    <figcaption>DateTime 형식 데이터 조회</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>DateTime 형식 데이터에 TimeZone 정보를 추가해서 인식</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>JVM 기본 시간대로 변환</figcaption>
</figure>
...
먼저, **_2024-09-03_** LocalDate 정보가 Date로 바뀌면서
LocalTimeZone인 KST의 영향을 받아 **_2024-09-03 00:00:00(UTC+9)_** 로 바뀝니다.

JDBC에서 캐싱된 TimeZone 정보로 이 시간을 변환합니다.(왜 TimeZone이 UTC로 캐싱된지는 정확히 모르겠습니다.)   
_2024-09-03 00:00:00(UTC+9)_ -> **_2024-09-02 15:00:00(UTC+0)_**
